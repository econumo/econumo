...
func (a *OAuthUsers) ReplaceVerifiedEmail(ctx context.Context, userID vo.Id, email string, generation int64) (int64, error) {
	return a.users.ReplaceVerifiedEmail(ctx, userID, email, generation)
}
