// Package repo implements account.Repository (accounts + accounts_options +
// the balance read + the balance-correction insert) over the sqlc-generated
// queries.
//
...
// Repo implements account.Repository.
type Repo struct {
