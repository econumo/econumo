...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/currency/set-currency-rate": {
            "post": {
                "security": [
                    {
                        "Bearer": []
                ...
                "parameters": [
                    {
                        "description": "Set currency rate request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.SetCurrencyRateRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/model.SetCurrencyRateResult"
                                        }
                                    }
                                }
                            ]
