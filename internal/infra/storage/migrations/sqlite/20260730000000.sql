...
ALTER TABLE recurring_transactions RENAME TO recurring_transactions__old;
...
CREATE TABLE transactions (id TEXT NOT NULL COLLATE BINARY
        ...
        , recurring_id TEXT DEFAULT NULL REFERENCES recurring_transactions (id) ON DELETE SET NULL
        , PRIMARY KEY(id)
...
INSERT INTO recurring_transactions SELECT * FROM recurring_transactions__old;
...
DROP TABLE recurring_transactions__old;
...
-- 20260101000000.sql (plus the recurring indexes from 20260727000000.sql /
-- 20260729000000.sql), EXCEPT UNIQ_37C4469377153098 (the old code-unique
