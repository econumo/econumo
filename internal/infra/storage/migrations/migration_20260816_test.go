...
// Verifies the 20260816000000 migration: budgets_elements_limits.period is
...
const periodFormatVersion = "20260816000000"
...
// TestMigration20260816_CollapsesDuplicateFormatsAndCanonicalizes covers the
...
func TestMigration20260816_CollapsesDuplicateFormatsAndCanonicalizes(t *testing.T) {
...
// TestMigration20260816_LeavesCanonicalRowsAlone proves the sweep is a no-op on
// an already-clean database, so re-running it (or running it on a fresh
// install) changes nothing.
func TestMigration20260816_LeavesCanonicalRowsAlone(t *testing.T) {
...
// TestMigration20260816_EveryPeriodIsCanonical is the invariant the merge code
// then relies on: no stored period differs from its datetime() normalization.
func TestMigration20260816_EveryPeriodIsCanonical(t *testing.T) {
