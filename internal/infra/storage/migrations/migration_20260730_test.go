...
// Verifies the 20260730000000 sqlite migration: the currencies FK-closure
...
func TestMigration20260730_DataSurvivesRebuild(t *testing.T) {
	db := openFK(t)
	...
	seed := []string{
		...
		`INSERT INTO recurring_transactions (id, user_id, account_id, type, amount, description, schedule, next_payment_at, scheduled_day, created_at, updated_at)
		 VALUES ('rt1', 'u1', 'a1', 0, '10.00000000', 'rent', 'monthly', '2026-02-01 00:00:00', 1, '2026-01-01 00:00:00', '2026-01-01 00:00:00')`,
		`INSERT INTO transactions (id, user_id, account_id, description, amount, type, spent_at, created_at, updated_at, recurring_id)
		 VALUES ('t1', 'u1', 'a1', '', '10.00000000', 0, '2026-01-02 00:00:00', '2026-01-02 00:00:00', '2026-01-02 00:00:00', 'rt1')`,
	...
	for table, want := range map[string]int{
		...
		"budgets": 1, "budgets_elements": 1, "recurring_transactions": 1,
	} {
		var n int
...
func TestMigration20260730_PartialUniqueAndNewTable(t *testing.T) {
	db := openFK(t)
	ctx := context.Background()
