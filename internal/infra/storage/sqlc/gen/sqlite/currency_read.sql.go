...
type GetUserCurrencyListViewParams struct {
	UserID   *string
	UserID_2 string
	UserID_3 string
	UserID_4 string
...
func (q *Queries) GetUserCurrencyListView(ctx context.Context, arg GetUserCurrencyListViewParams) ([]GetUserCurrencyListViewRow, error) {
	rows, err := q.db.QueryContext(ctx, getUserCurrencyListView,
		arg.UserID,
		arg.UserID_2,
		arg.UserID_3,
		arg.UserID_4,
