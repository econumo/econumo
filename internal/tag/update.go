...
func (s *Service) mutateWithUnique(ctx context.Context, id, userID vo.Id, name string) (*model.Tag, error) {
	return s.mutateChecked(ctx, id, userID, func(txCtx context.Context, t *model.Tag, now time.Time) error {
