...
func init() {
	register(Scenario{Name: "negative_paths", Calls: func() []Call {
		return []Call{
			...
			{Label: "err:move-account-bad-folder", Method: "POST", Path: "/api/v1/account/move-account", Auth: "owner",
				Body: map[string]any{"id": OwnerAccount, "afterId": nil, "folderId": "not-a-uuid"}},
			...
			{Label: "err:move-account-bad-uuid", Method: "POST", Path: "/api/v1/account/move-account", Auth: "owner",
				Body: map[string]any{"id": "not-a-uuid", "afterId": nil, "folderId": OwnerFolder}},
			{Label: "err:move-folder-bad-uuid", Method: "POST", Path: "/api/v1/account/move-folder", Auth: "owner",
