...
SWAG_INIT     = go run github.com/swaggo/swag/cmd/swag@$(SWAG_VERSION) init -g doc.go -d .,../handler,../../app,../../user,../../currency,../../account,../../category,../../tag,../../payee --parseInternal --parseDependency
