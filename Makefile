.PHONY: help web-install web-dev web-bundle web-lint web-react-install web-react-dev web-react-test web-react-lint web-react-bundle go-build go-run test test-cover go-lint regression test-engines pg-ensure up down publish-dev publish-buildx-ensure swagger swagger-check
