...
SWAG_INIT     = go run github.com/swaggo/swag/cmd/swag@$(SWAG_VERSION) init -g doc.go -d .,../../user,../../currency,../../account,../../category,../../tag,../../label,../../payee,../../transaction,../../connection,../../budget,../../recurring,../../system,../../imports,../../oauth,../../model --parseInternal --parseDependency
